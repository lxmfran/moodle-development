...
$string['notemplatefound'] = 'There were no templates found.';
$string['nologsfound'] = 'There were no logs found for this backup.';
$string['pluginname'] = 'template report';
$string['strftimetime'] = '%I:%M:%S %p';
$string['viewlogs'] = 'View logs';
$string['privacy:metadata'] = 'The template reports plugin does not store any personal data.';
