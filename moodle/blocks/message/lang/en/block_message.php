...
$string['message:addinstance'] = 'Add a new latest announcements block';
$string['message:myaddinstance'] = 'Add a new latest announcements block to Dashboard';
...
$string['message:hello'] = 'Hello!! Welcome Mr/Ms ';
